  ...
  return (
    <div className="container mx-auto py-8 px-2 md:px-8">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-2xl font-bold" style={{ color: '#5B7FFF' }}>{EXTERNAL_EDIT_TEXTS.pageTitle}</h1>
      </div>
      <Card className="mb-8 p-6" style={{ borderColor: '#E0E0F0' }}>
        <h2 className="text-lg font-semibold mb-4" style={{ color: '#5B7FFF' }}>{EXTERNAL_EDIT_TEXTS.basicInfo}</h2>
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-2 flex justify-center mt-6">
            <Button style={{ background: '#22C55E', color: '#fff', width: 200 }}>{EXTERNAL_EDIT_TEXTS.save}</Button>
          </div>
        </form>
      </Card>

      <Card className="p-6">
        <h2 className="text-lg font-semibold mb-4" style={{ color: '#5B7FFF' }}>{EXTERNAL_EDIT_TEXTS.history}</h2>
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow className="bg-[#7C6CF6] text-white">
                <TableHead className="text-white">{EXTERNAL_EDIT_TEXTS.table.date}</TableHead>
                <TableHead className="text-white">{EXTERNAL_EDIT_TEXTS.table.action}</TableHead>
                <TableHead className="text-white">{EXTERNAL_EDIT_TEXTS.table.status}</TableHead>
                <TableHead className="text-white">{EXTERNAL_EDIT_TEXTS.table.updater}</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
